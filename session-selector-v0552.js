// UbayBian v0.5.79 — Session selector bridge for Learning Deck + Assessment
(() => {
  'use strict';
  ...
  function examAvailable(profileId, subjectId) {
    if (profileId === 'bian') return ['bahasa-indonesia', 'english', 'math', 'science'].includes(subjectId);
