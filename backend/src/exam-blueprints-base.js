...
const BLUEPRINTS = Object.freeze({
  ...
  'ubay-bahasa-indonesia-mid-s1-2026': Object.freeze({
    id: 'ubay-bahasa-indonesia-mid-s1-2026',
    profileSlug: 'ubay',
    subjectId: 'bahasa-indonesia',
    semester: '1',
    title: 'Bahasa Indonesia Mid Exam S1',
    subtitle: 'Grade 7 · Semester 1 · 2026/2027',
    durationMinutes: 90,
    targetQuestions: 30,
    topicTargets: Object.freeze({
    ...
    topicDifficultyTargets: Object.freeze({
      'ubay-bi-desc-concept': Object.freeze({ sedang: 2 }),
      'ubay-bi-desc-info': Object.freeze({ mudah: 1, sedang: 1, sulit: 1 }),
      'ubay-bi-desc-concrete': Object.freeze({ mudah: 1, sedang: 1, sulit: 1 }),
      'ubay-bi-desc-detail': Object.freeze({ mudah: 1, sedang: 1, sulit: 1 }),
      'ubay-bi-desc-personification': Object.freeze({ sedang: 1, sulit: 1 }),
      'ubay-bi-desc-address': Object.freeze({ sedang: 1 }),
      'ubay-bi-desc-morphology': Object.freeze({ mudah: 1, sedang: 1, sulit: 1 }),
      'ubay-bi-proc-structure': Object.freeze({ mudah: 1, sedang: 2, sulit: 1 }),
      'ubay-bi-proc-order': Object.freeze({ mudah: 1, sedang: 1, sulit: 1 }),
      'ubay-bi-proc-invitation': Object.freeze({ mudah: 1, sedang: 1 }),
      'ubay-bi-proc-adverb': Object.freeze({ sedang: 2 }),
      'ubay-bi-integrative': Object.freeze({ mudah: 1, sedang: 1 }),
    }),
  }),
});
...
const TOPIC_ALIASES = Object.freeze({
  ...
  'ubay-bi-desc-concept': ['teks deskripsi pengertian, tujuan & ciri'],
  'ubay-bi-desc-info': ['teks deskripsi informasi & objek'],
  'ubay-bi-desc-concrete': ['teks deskripsi kata konkret & pancaindra'],
  'ubay-bi-desc-detail': ['teks deskripsi kalimat perincian & kepaduan'],
  'ubay-bi-desc-personification': ['teks deskripsi majas personifikasi'],
  'ubay-bi-desc-address': ['teks deskripsi kata sapaan'],
  'ubay-bi-desc-morphology': ['teks deskripsi imbuhan men & peluluhan'],
  'ubay-bi-proc-structure': ['teks prosedur informasi, tujuan & struktur'],
  'ubay-bi-proc-order': ['teks prosedur urutan langkah & kejelasan'],
  'ubay-bi-proc-invitation': ['teks prosedur kalimat ajakan & larangan'],
  'ubay-bi-proc-adverb': ['teks prosedur inversi & adverbia'],
  'ubay-bi-integrative': ['integratif deskripsi vs prosedur'],
